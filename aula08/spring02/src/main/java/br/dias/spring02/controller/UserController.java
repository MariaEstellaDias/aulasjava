package br.dias.spring02.controller;
...
import br.dias.spring02.dto.UserDTO;
...
public class UserController {
    ...
    @GetMapping("/id/{id}")
    public ResponseEntity<User> buscaPorId(@PathVariable int id) { // PathVariable - variável vem na URI
    ...
    @GetMapping("/id2/{id}")
    public ResponseEntity<UserDTO> buscaPorId2(@PathVariable int id) { // PathVariable - variável vem na URI
        User user = repo.findById(id).orElse(null);
